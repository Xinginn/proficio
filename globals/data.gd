...
#  lands.append(LandData.new(2, "plain", 8, {"cristal_shards": 4, "ore_shards": 2, "stone_shards": 3}))
  ...
  # id, product, name, stamina, skill, xp, {resources}, ?needed_progress = 1.0
  ...
  crafts.append(CraftData.new(24, HealingPotion, "healing_potion", 4, "apothecary", 4, {"herb": 6, "ore": 2}, 1.5))
