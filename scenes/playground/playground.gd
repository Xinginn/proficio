...
onready var hotkeys_manager = $Camera/HotkeysManager
...
func _ready():
  ...
  player.connect('tech_list_changed', hotkeys_manager, "_on_tech_list_changed")
  player.connect('cooldowns_changed', hotkeys_manager, "_on_player_cooldowns_changed")
  hotkeys_manager.connect("hotkeys_switched", player, "_on_hotkeys_switch_requested")
  ...
  player.add_resource("skin", 12)
  player.add_resource("cristal", 8)
  player.add_resource("stone", 20)
